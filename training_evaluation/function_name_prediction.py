...
def main(args):
    """
    Generations function name predictions by checking
    that the path to write prediction results exists. If it does not exist
    then the path is created. Function name predictions are then generated.
    ...
    generate_function_name_pred(args)

def generate_function_name_pred(args):
    logging.basicConfig(
